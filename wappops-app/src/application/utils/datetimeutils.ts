...
/**
 * Devuelve el tiempo transcurrido en horas entre dos fechas.
 * @param { Date } from - Fecha de inicio.
 * @param { Date } to - Fecha de fin. Si no se proporciona, se usa la fecha actual.
 * @returns { number } - Número de horas transcurridas entre las dos
 */
